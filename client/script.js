...
function getPerfil(){
    $.getJSON(`http://${host}:${port}/perfil`, function (data) {
...
function savePerfil(){
    ...
    let data = { email: emailValue, passwd: passwdValue };
...
function getNotification(){
    $.getJSON(`http://${host}:${port}/notification`, (data) => {
...
function getConsumption(){
    $.getJSON(`http://${host}:${port}/water-consumption`, (data) => {
        if (data && data.date)
        {
